...
function obtenerLibros($conexion) {
    $sql = "SELECT * FROM libros WHERE espacio = 'disponible'";
    $result = $conexion->query($sql);
    return $result;
}

function obtenerLibros_ocupados($conexion) {
    $sql = "SELECT * FROM libros WHERE espacio = 'ocupado'";
    $result = $conexion->query($sql);
    return $result;
}

function obtenerLibros_reservados($conexion) {
    $sql = "SELECT * FROM libros WHERE espacio = 'reservado'";
    $result = $conexion->query($sql);
    return $result;
}