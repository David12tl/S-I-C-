...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $administradores = "administrdores";

    $id_nombre = trim($_POST['id_nombre']);
    $NOMBRE = trim($_POST['NOMBRE']);
    $CORREO = trim($_POST['CORREO']);
    $CONTRASEÑA = trim($_POST['CONTRASEÑA']);
    $CLAVE_ADM = trim($_POST['CLAVE_ADM']);
    ...
    if (isset($_FILES['avatar'])) {
        ...
        if (move_uploaded_file($archivoTemporal, $rutaDestino)) {
            ...
            $sql = "INSERT INTO $administradores (id_nombre, NOMBRE, CORREO, CONTRASEÑA, CLAVE_ADM) VALUES ('$id_nombre','$NOMBRE', '$CORREO', '$CONTRASEÑA', '$CLAVE_ADM')"; 
...
{
    $sql = "SELECT * FROM administradores ORDER BY id_nombre ASC";
