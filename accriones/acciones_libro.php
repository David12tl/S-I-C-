...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_FILES['Portada'])){
        ...
        if (move_uploaded_file($archivoTemporal, $rutaDestino)) {
            ...
            $sql = "INSERT INTO $Libros (nombre, autor, espacio, fecha_publicacion, edicion, genero, portada) 
            VALUES ('$nombre', '$autor', '$espacio', '$fecha_publicacion', '$edicion', '$genero', '$nombreArchivo')";
...
{
    $sql = "SELECT * FROM libros ORDER BY id_libros ASC";
