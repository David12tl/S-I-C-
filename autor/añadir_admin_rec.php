    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container-fluid">
            <ul class="nav nav-tabs nav-justified"  style="font-size: 17px;">
                <li role="presentation"><a href="autor_añadir.php">Administradores</a></li>
                <li role="presentation" class="active"><a href="añadir_admin_rec.php">Administrador de recursos</a></li>
        ...
        <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    Bienvenido a la sección para registrar nuevos Administradores de recursos, debes de llenar todos los campos del siguiente formulario para registrar a un nuevo administrador de recursos. Recuerda que el administrador de recursos tiene acceso a funciones restringidas, por lo que debes de tener cuidado al momento de asignar un nuevo administrador. Si tienes alguna duda, puedes consultar la sección de ayuda o contactar a nuestro equipo de soporte.
                </div>
            </div>
        </div>
        <div class="container-fluid">
            <div class="row">
                <div class="col-xs-12 lead">
                    <ol class="breadcrumb">
                      <li class="active">Nuevo administrador de recursos</li>
                      <li><a href="../listas/adm_rec.php">Listado de administradores de recursos</a></li>
                    </ol>
                </div>
            </div>
        </div>
        <div class="container-fluid">
            <div class="container-flat-form">
                <div class="title-flat-form title-flat-blue">Registrar un nuevo administrador de recursos</div>
                <form class="form-padding" action="añadir_recursos_funcion.php" method="POST">
                    <div class="row">
                        <div class="col-xs-12">
                        ...
                        <div class="col-xs-12 col-sm-6">
                            <div class="group-material">
                                <input name="CORREO" type="text" class="material-control tooltips-general" placeholder="Correo"  maxlength="50" data-toggle="tooltip" data-placement="top" title="Escribe su correo">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                                <label>Correo</label>
                            </div>
                        ...
                        <div class="col-xs-12">
                           <div class="group-material">
                                <input name="CONTRASEÑA" type="text" class="material-control tooltips-general input-check-user" placeholder="Contraseña" title="Escribe su contraseña">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                        ...
                        <div class="col-xs-12 col-sm-6">
                           <div class="group-material">
                                <input name="CLAVE_REC" type="text" class="material-control tooltips-general" placeholder="Clave administrador de recursos" required="" maxlength="200" data-toggle="tooltip" data-placement="top" title="Repite la contraseña">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                                <label>Clave de administrador</label><p><small>1991920513110</small></p>
                           </div>
                        </div>
                       <div class="col-xs-12">
                            <p class="text-center">
