    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container-fluid">
            <ul class="nav nav-tabs nav-justified"  style="font-size: 17px;">
                ...
                <li role="presentation" class="active"><a href="añadir_users.php">Usuarios</a></li>
            </ul>
        </div>
        <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    Bienvenido a la sección para registrar nuevos Usuarios, debes de llenar todos los campos del siguiente formulario para registrar a un nuevo usuario. Si tienes alguna duda, puedes consultar la sección de ayuda o contactar a nuestro equipo de soporte.
                </div>
            </div>
        </div>
        <div class="container-fluid">
            <div class="row">
                <div class="col-xs-12 lead">
                    <ol class="breadcrumb">
                      ...
                      <li><a href="../listas/adm_users.php">Listado de Usuarios</a></li>
                    </ol>
                </div>
            </div>
        </div>
        <div class="container-fluid">
            <div class="container-flat-form">
                ...
                <form class="form-padding" action="../autor/agregar_usuario.php" method="POST">
                    <div class="row">
                        <div class="col-xs-12">
                        ...
                        <div class="col-xs-12 col-sm-6">
                            <div class="group-material">
                                <input name="CORREO" type="text" class="material-control tooltips-general" placeholder="Correo"  maxlength="50" data-toggle="tooltip" data-placement="top" title="Escribe su correo electronico">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                                <label>Correo</label>
                            </div>
                        ...
                        <div class="col-xs-12">
                           <div class="group-material">
                                <input name="CONTRASEÑA" type="text" class="material-control tooltips-general input-check-user" placeholder="Contraseña" title="Escriba su contraseña">
                                <span class="highlight"></span>
                                <span class="bar"></span>
