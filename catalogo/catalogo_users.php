            ...
            <div class="col-md-12">
                <h1 class="text-center">
                    ...
                    <span class="float-start">
                            <a href="../home_users.php" class="btn btn-primary" title="Regresar al Inicio" style="text-decoration: none;">
                ...
                <?php
                include("../catalogo/components/catalogos_users_funcion.php"); ?>
            </div>
        </div>
    </div>
