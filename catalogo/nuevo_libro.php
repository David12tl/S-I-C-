...
<head>
    ...
    <link rel="stylesheet" href="../css/catalogo_libros.css" />
...
<body>
    ...
    <h1 class="text-center mt-5 mb-5 fw-bold"><img src="../assets/img/logo_ingetec.jpg" alt=""  style="width: 25%; height: auto;" > Catalogo de Articulos</h1>
    <div class="container">
            ...
            <div class="col-md-12">
                <h1 class="text-center">
                    ...
                    <span class="float-start">
                        ...
                        <a href="../home_adm.php" class="btn btn-primary" title="Regresar al Inicio" style="text-decoration: none; margin-left: 10px;">
                            <i class="bi bi-house"> REGRESAR </i>
                        </a>
                    </span>
                    Lista de Articulos (<?php echo $totalLibros ?>)
                ...
                <?php
                include("components/catalogo_libros.php"); ?>
            </div>
        </div>
    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3 mt-4">
                        ...
                        <input class="form-control form-control-sm" type="file" name="Portada" accept="image/png, image/jpeg, img/pdf" />
                    </div>
