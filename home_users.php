        ...
        <div class="full-reset container-menu-movile nav-lateral-scroll">
            ...
            <div class="full-reset nav-lateral-list-menu">
                <ul class="list-unstyled">
                    <li><a href="home_users.php"><i class="zmdi zmdi-home zmdi-hc-fw"></i>&nbsp;&nbsp; Inicio</a></li>
                        <ul class="list-unstyled">
                            <li><a href="catalogo/catalogo_users.php"><i class="zmdi zmdi-bookmark-outline zmdi-hc-fw"></i>&nbsp;&nbsp; Catálogo</a></li>
                        </ul>
                    </li>
    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        <nav class="navbar-user-top full-reset">
            <ul class="list-unstyled full-reset">
                ...
                <span class="all-tittles">Usuarios</span>
                </li>
                ...
                <li  data-placement="bottom" title="Buscar libro">
                    <a href="buscador/buscar_libro.php"> <h2><i class="zmdi zmdi-search"></i></h2></a>
                </li>
        ...
        <div class="container">
            ...
            <div class="text-center" style="margin-top: 20px;">
                <h2 class="all-tittles">Bienvenido al sistema de control de inventario</h2>
                <p>Este sistema tiene como objetivo facilitar la gestión de libros y recursos de el Tecnologico.</p>
            </div>
        </div>
        <section>
            <img src="assets/img/fondo.jpg" alt="" class="img-responsive center-box" style="width: 100%; height: 100vh; margin: 0; padding: 0; display: block;">
        </section>
