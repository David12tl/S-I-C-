            ...
            <div class="full-reset nav-lateral-list-menu">
                <ul class="list-unstyled">
                    ...
                    <li>
                        ...
                        <ul class="list-unstyled">
                            <li><a href="../../administrador/libros_disponibles.php"><i class="zmdi zmdi-calendar zmdi-hc-fw"></i>&nbsp;&nbsp; Todos los préstamos</a></li>
                            <li>
                                <a href="../../administrador/libros_ocupados.php"><i class="zmdi zmdi-time-restore zmdi-hc-fw"></i>&nbsp;&nbsp; Devoluciones pendientes <span class="label label-danger pull-right label-mhover"></span></a>
                            </li>
                            <li>
                                <a href="../../administrador/libros_reservados.php"><i class="zmdi zmdi-timer zmdi-hc-fw"></i>&nbsp;&nbsp; Reservaciones <span class="label label-danger pull-right label-mhover"></span></a>
                            </li>
                        </ul>
                    </li>
    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container">
            <div class="page-header">
              <h1 class="all-tittles">Sistema de control de inventario <small>LISTA DE LiBROS DISPONIBLES</small></h1>
            </div>
        </div>
        <div class="container-fluid">
            <ul class="nav nav-tabs nav-justified"  style="font-size: 17px;">
                <li role="presentation" ><a href="../../administrador/libros_disponibles.php">Libros Disponibles</a></li>
                <li role="presentation" class="active"><a href="articulos_disponibles.php">Artuculos Disponibles</a></li>
            </ul>
        </div>
        <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                <div class="col-xs-12 col-sm-4 col-md-3">
                <img src="../../../assets/img/category.png" alt="pdf" class="img-responsive center-box" style="max-width: 110px;">
                </div>
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    <p>Bienvenido a la sección Lista de Articulos, en este apartado podrás visualizar los Articulos en estado disponible</p>
                </div>
            </div>
        </div>
        <div class="container-fluid">
            <div class="row">
                <div class="col-xs-12 lead">
                    <ol class="breadcrumb">
                      <li><a href="../../catalogo/nuevo_libro.php">AGREGAR</a></li>
                    </ol>
                </div>
            </div>
        </div>
