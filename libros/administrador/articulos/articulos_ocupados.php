    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container-fluid">
            <ul class="nav nav-tabs nav-justified"  style="font-size: 17px;">
                <li role="presentation" ><a href="../../administrador/libros_ocupados.php">Libros Ocupados</a></li>
                <li role="presentation" class="active"><a href="articulos_ocupados.php">Artuculos Ocupados</a></li>
            </ul>
        </div>
        <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                <div class="col-xs-12 col-sm-4 col-md-3">
                <img src="../../../assets/img/section.png" alt="pdf" class="img-responsive center-box" style="max-width: 110px;">
                </div>
