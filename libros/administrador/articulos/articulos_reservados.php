    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container">
            <div class="page-header">
              <h1 class="all-tittles">Sistema de control de inventario <small>LISTA DE ARTICULOS DISPONIBLES</small></h1>
            </div>
        </div>
        <div class="container-fluid">
            <ul class="nav nav-tabs nav-justified"  style="font-size: 17px;">
                <li role="presentation" ><a href="../../administrador/libros_reservados.php">Libros Ocupados</a></li>
                <li role="presentation" class="active"><a href="articulos_reservados.php">Artuculos Ocupados</a></li>
            </ul>
        </div>
        <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                <div class="col-xs-12 col-sm-4 col-md-3">
                <img src="../../../assets/img/user-sesion.png" alt="pdf" class="img-responsive center-box" style="max-width: 110px;">
                </div>
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    <p>Bienvenido a la sección Lista de Articulos, en este apartado podrás visualizar los Articulos en estado ocupados</p>
                </div>
            </div>
        </div>
        <div class="container-fluid">
