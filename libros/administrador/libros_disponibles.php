                ...
                <ul class="list-unstyled">
                    ...
                    <li>
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li><a href="../../lista/adm_rec.php"><i class="zmdi zmdi-accounts zmdi-hc-fw"></i>&nbsp;&nbsp; Listas administrador de recursos</a></li>
    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container-fluid">
            <ul class="nav nav-tabs nav-justified"  style="font-size: 17px;">
                <li role="presentation"  class="active"><a href="libros_disponibles.php">Libros Disponibles</a></li>
                <li role="presentation"><a href="articulos/articulos_disponibles.php">Artuculos Disponibles</a></li>
            </ul>
        </div>
