    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container-fluid">
            <ul class="nav nav-tabs nav-justified"  style="font-size: 17px;">
                <li role="presentation" class="active"><a href="libros_ocupados.php">Libros Ocupados</a></li>
                <li role="presentation" ><a href="articulos/articulos_ocupados.php">Artuculos Ocupados</a></li>
            </ul>
        </div>
