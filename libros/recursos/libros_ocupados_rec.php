...
<?php
    ...
    $Libros = obtenerLibros_ocupados($conexion);
    ...
    <div class="navbar-lateral full-reset">
        ...
        <div class="full-reset container-menu-movile nav-lateral-scroll">
            ...
            <div class="full-reset" style="padding: 10px 0; color:#fff;">
                <figure>
                    <img src="../../assets/img/logo.png" alt="Biblioteca" class="img-responsive center-box" style="width:100%; margin-top: -3.6%">
                </figure>
            ...
            <ul class="list-unstyled">
                    ...
                    <li>
                        ...
                        <ul class="list-unstyled">
                            <li><a href="../../autor/autor_rec.php"><i class="zmdi zmdi-accounts zmdi-hc-fw"></i>&nbsp;&nbsp; Autor</a></li>
                    ...
                    <li>
                        ...
                        <ul class="list-unstyled">
                            <li><a href="libros_disponible_rec.php"><i class="zmdi zmdi-calendar zmdi-hc-fw"></i>&nbsp;&nbsp;Libros disponibles</a></li>
                            <li>
                                <a href="libros_ocupados_rec.php"><i class="zmdi zmdi-time-restore zmdi-hc-fw"></i>&nbsp;&nbsp;Libros Ocupados<span class="label label-danger pull-right label-mhover"></span></a>
                            </li>
                            <li>
                                <a href="libros_reservados_rec.php"><i class="zmdi zmdi-timer zmdi-hc-fw"></i>&nbsp;&nbsp; Libros Reservaciones <span class="label label-danger pull-right label-mhover"></span></a>
                            </li>
                        </ul>
                    </li>
    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        <nav class="navbar-user-top full-reset">
            <ul class="list-unstyled full-reset">
                ...
                <li  data-placement="bottom" title="Buscar libro">
                    <a href="buscar_libro_rec.php"> <h2><i class="zmdi zmdi-search"></i></h2></a>
                </li>
        ...
        <div class="container">
            <div class="page-header">
              <h1 class="all-tittles">Sistema de control de inventario <small>LISTA DE LIBROS OCUPADOS</small></h1>
            </div>
        </div>
        <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    <p>Bienvenido a la sección Lista de libros, en este apartado podrás visualizar los libros es estado disponible</p>
                </div>
            </div>
        </div>
