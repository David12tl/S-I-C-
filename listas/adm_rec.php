...
<?php
    ...
    include("../acciones/acciones_rec.php");
    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div>
             <a href="../autor/añadir_admin_rec.php" class="btn btn-success" style="background-color: #1e2542;  border: none; margin-left: 5%;"> nuevo administrador de recursos</a>
        </div>
    ...
    <table class="table table-hover" id="table_empleados">
        <thead>
            <tr>
                <th colspan="5" class="text-center all-tittles">Lista de administradores de recursos</th>
            </tr>
            <tr>
                <th scope="col">id</th>
        ...
        <t>
            ...
            foreach ($empleados as $empleado) { ?>
                <tr id="empleado_<?php echo $empleado['id_nombre']; ?>">
                    ...
                    <td><?php echo $empleado['CLAVE_REC']; ?></td>
                </tr>
            <?php } ?>
        </t body>
    </table>
