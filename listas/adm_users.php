...
<?php
    ...
    include("../acciones/acciones_user.php");
    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container">
            <div class="page-header">
              <h1 class="all-tittles">Sistema de Control de Inventario <small>Listas de usuarios</small></h1>
            </div>
        </div>
        <div>
             <a href="../autor/añadir_users.php" class="btn btn-success" style="background-color: #1e2542;  border: none; margin-left: 5%;"> nuevo Usuario</a>
        </div>
    ...
    <table class="table table-hover" id="table_empleados">
        <thead>
            <tr>
                <th colspan="5" class="text-center all-tittles">Lista de usuarios</th>
            </tr>
            <tr>
                <th scope="col">id</th>
