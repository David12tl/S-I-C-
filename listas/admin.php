...
<?php
    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container">
            <div class="page-header">
              <h1 class="all-tittles">Sistema de Cotrol de Inventario</h1>
            </div>
        </div>
        <div>
             <a href="../autor/autor_añadir.php" class="btn btn-success" style="background-color: #1e2542;  border: none; margin-left: 5%;"> nuevo administrador</a>
        </div>
    ...
    <table class="table table-hover" id="table_empleados">
        <thead style="aling: center;">
            <tr>
                <th colspan="5" class="text-center all-tittles">Lista de administradores</th>
            <tr>
                <th scope="col">Id</th>
